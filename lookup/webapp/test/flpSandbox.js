			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dlwlookup-display": {
								"semanticObject": "dlwlookup",
								"action": "display",
								"description": "Lookup Fiori application.",
								"title": "Lookup",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dlw.lookup",
									"url": sap.ui.require.toUrl("dlw/lookup")
								}
							}
						}
					}
